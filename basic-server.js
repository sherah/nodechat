...
var requestListener = function (request, response) {
  ...
  // var messages = handleRequest.handleRequest(request);
  // headers['Content-Length'] = messages.length;
  ...
  switch(request.method)
  {
    case "OPTIONS":
      ...
      break;
    case "GET":
      handleRequest.handleGetRequest(request, response);
      break;
    case "POST":
      handleRequest.handlePostRequest(request, response);
      break;
    default:
  ...
  // var indexHTML = fs.readFileSync("/Users/Catalyst/code/chat-client/index.html");
